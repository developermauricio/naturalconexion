		...
		<div class="wd-box-shadow">
			<div class="wd-box-shadow-item">
				...
				<div class="xts-input-append">
					<input name="horizontal" id="horizontal" type="number" class="wd-text-input" value="<?php echo esc_attr( $desktop['horizontal'] ); ?>" aria-label="<?php esc_html_e( 'Horizontal', 'woodmart' ); ?>">
			...
			<div class="wd-box-shadow-item">
				...
				<div class="xts-input-append">
					<input name="vertical" id="vertical" type="number" class="wd-text-input" value="<?php echo esc_attr( $desktop['vertical'] ); ?>" aria-label="<?php esc_html_e( 'Vertical', 'woodmart' ); ?>">
					<span class="add-on">px</span>
				</div>
			</div>
			<div class="wd-box-shadow-item">
				...
				<div class="xts-input-append">
					<input name="blur_radius" id="blur" type="number" class="wd-text-input" value="<?php echo esc_attr( $desktop['blur'] ); ?>" aria-label="<?php esc_html_e( 'Blur radius', 'woodmart' ); ?>">
					<span class="add-on">px</span>
				</div>
			</div>
			<div class="wd-box-shadow-item">
				...
				<div class="xts-input-append">
					<input name="spread_radius" id="spread" type="number" class="wd-text-input" value="<?php echo esc_attr( $desktop['spread'] ); ?>" aria-label="<?php esc_html_e( 'Spread radius', 'woodmart' ); ?>">
					<span class="add-on">px</span>
				</div>
			</div>
			<div class="wd-box-shadow-item wd-color">
				...
				<input name="color" id="color" type="text" class="wd-color-input" value="<?php echo esc_attr( $desktop['color'] ); ?>">
			</div>
