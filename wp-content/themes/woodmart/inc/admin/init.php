...
if ( ! function_exists( 'woodmart_admin_scripts' ) ) {
	function woodmart_admin_scripts() {
		...
		wp_enqueue_script( 'woodmart-import-scripts', WOODMART_ASSETS . '/js/import.js', array(), $version, true );
		...
		if ( 'wpb' === woodmart_get_current_page_builder() ) {
			...
			wp_enqueue_script( 'woodmart-responsive-spacing', WOODMART_ASSETS . '/js/vc-fields/responsive-spacing.js', array(), $version, true );
			...
			wp_enqueue_script( 'woodmart-vc-box-shadow', WOODMART_ASSETS . '/js/vc-fields/box-shadow.js', array(), $version, true );
			...
			wp_enqueue_script( 'wd-slider-responsive', WOODMART_ASSETS . '/js/vc-fields/slider-responsive.js', array(), $version, true );
			wp_enqueue_script( 'wd-number', WOODMART_ASSETS . '/js/vc-fields/number.js', array(), $version, true );
		}
