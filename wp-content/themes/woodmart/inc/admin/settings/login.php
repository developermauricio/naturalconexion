...
Options::add_field(
	array(
		...
		'name'     => '',
		'group'    => esc_html__( 'Social login', 'woodmart' ),
		'content'  => 'Enable login with Facebook on your web-site.
...
Options::add_field(
	array(
		...
		'name'     => '',
		'group'    => esc_html__( 'Social login', 'woodmart' ),
		'content'  => 'You can enable login with Google on your web-site.
...
Options::add_field(
	array(
		...
		'name'     => '',
		'group'    => esc_html__( 'Social login', 'woodmart' ),
		'content'  => 'To enable login with vk.com you need to create an APP here <a href="https://vk.com/dev" target="_blank">https://vk.com/dev</a>.
