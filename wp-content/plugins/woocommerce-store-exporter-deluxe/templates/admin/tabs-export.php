...
<?php
		foreach( $export_types as $export_type ) {
			...
			if( file_exists( WOO_CD_PATH . 'templates/admin/' . $template ) ) {
				...
				$message = sprintf( __( 'We couldn\'t load the template file <code>%s</code> within <code>%s</code>, this file should be present.', 'woocommerce-exporter' ), $template, WOO_CD_PATH . 'templates/admin/...' );
	?>
