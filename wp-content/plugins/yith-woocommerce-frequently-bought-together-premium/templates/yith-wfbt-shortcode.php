			...
			<?php foreach ( $args['products'] as $product_id ) : $product = wc_get_product( $product_id ); ?>
				...
				<li class="yith-wfbt-single-product product">
					...
					<div class="yith-wfbt-product-info">
						...
						<?php echo 'yes' === get_option( 'yith-wfbt-slider-product-price', 'yes' ) ? '<div class="product-price">' . $product->get_price_html() . '</div>' : ''; // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped ?>

						<?php if ( 'yes' === get_option( 'yith-wfbt-slider-product-rating', 'yes' ) ) {
