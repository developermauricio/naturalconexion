...
if(!class_exists('H5VP_Block')){
    class H5VP_Block{
        ...
        function enqueue_script(){
            ...
            wp_register_style( 'h5vp-editor', plugin_dir_url( __FILE__ ) . 'dist/editor.css', array('bplugins-plyrio'), H5VP_VER, 'all' );
            // wp_register_style( 'h5vp-public', plugin_dir_url( __FILE__ ). 'dist/public.css' , array(), H5VP_VER );
