...
//	add_shortcode( 'woodmart_single_product_notices', 'woodmart_shortcode_single_product_notices' );
...
//	add_shortcode( 'woodmart_single_product_hook', 'woodmart_shortcode_single_product_hook' );
	...
	if ( function_exists( 'woodmart_get_current_page_builder' ) && 'wpb' === woodmart_get_current_page_builder() ) {
		...
		if ( function_exists( 'vc_add_shortcode_param' ) ) {
			...
			vc_add_shortcode_param( 'woodmart_box_shadow', 'woodmart_get_box_shadow_param' );
