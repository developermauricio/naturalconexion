    ...
    function column_default($item, $column_name) {
        ...
        switch ($column_name) {
            ...
            case 'feednumber':
                    ...
                    return $this->item_index.'&nbsp;<input '.( (empty($itemInfo['noGenAuto'])) ? 'checked="true"' : '' ).'" onchange="jQuery.fn.wpwoofSwicher('.$option_id.',jQuery(this).prop(\'checked\'));" type="checkbox" class="ios-switch toggleFeed" />';
            ...
            case 'feedname':
                ...
                return  '<p><img id="spinner'.$option_id.'" src="'.WPWOOF_ASSETS_URL.'img/spinner-2x.gif" style="width:16px;display: none;" title="In progress" alt="In progress" />&nbsp;' .  $addStr.$itemInfo['feed_name'] . '</p>';
            case 'feed_type':
