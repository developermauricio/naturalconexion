...
//                    }
    ...
    $(document).on('click',"input#add-extra-field-product-btn", function () {
        ...
        let $rowWrapper = $("<div>");
        let $row = $("<p>", { class: "form-field custom_field_type add-extra-fields"});
        let tagName =  $('#extraFieldList',div).val().replace('wpwoofattr_','');
        if (tagName=="custom_extra_field") {
            let maxExtraFieldNumber = 0;
            $('[name^="wpfoof-box-media[extra][custom-extra-field-"][name$="][custom_tag_name]').each(function() {
                var regex = /extra\]\[custom-extra-field-(\d*)]/;
                 if ((curArr = regex.exec($( this ).attr( "name" ))) !== null) {
                     curId = parseInt(curArr[1]);
                     if (curId >= maxExtraFieldNumber) maxExtraFieldNumber  = curId+1;
            ...
            tagName = 'custom-extra-field-'+maxExtraFieldNumber;
            $row.append($("<input>", { name: "wpfoof-box-media[extra]["+tagName+"][custom_tag_name]",style:"margin-left: -150px;width: 140px;", type: "text", class: "catalog-pro-custom-extra-field"}));
            $row.append($("<input>", { name: "wpfoof-box-media[extra]["+tagName+"][value]",placeholder:"Custom value",class:"short wc_input_"+tagName, type: "text"}));
...
//            $row.append($("<span>", { class:"extra-link-2-wrapper"}).html(wpwoof_help_links[tagName]));
            ...
            $linkWrap.append($("<input>", { id: "wpfoof-box-media[extra]["+tagName+"][feed_type][facebook]", name: "wpfoof-box-media[extra]["+tagName+"][feed_type][facebook]",type:"checkbox",checked:"checked"}));
            $linkWrap.append($("<label>", {for: "wpfoof-box-media[extra]["+tagName+"][feed_type][facebook]"}).html('Facebook'));
            $linkWrap.append($("<input>", { id: "wpfoof-box-media[extra]["+tagName+"][feed_type][google]", name: "wpfoof-box-media[extra]["+tagName+"][feed_type][google]",type:"checkbox",checked:"checked"}));
            $linkWrap.append($("<label>", {for: "wpfoof-box-media[extra]["+tagName+"][feed_type][google]"}).html('Google Merchant'));
            $linkWrap.append($("<input>", { id: "wpfoof-box-media[extra]["+tagName+"][feed_type][adsensecustom]", name: "wpfoof-box-media[extra]["+tagName+"][feed_type][adsensecustom]",type:"checkbox",checked:"checked"}));
            $linkWrap.append($("<label>", {for: "wpfoof-box-media[extra]["+tagName+"][feed_type][adsensecustom]"}).html('Google Custom Remarketing'));
            $linkWrap.append($("<input>", { id: "wpfoof-box-media[extra]["+tagName+"][feed_type][pinterest]", name: "wpfoof-box-media[extra]["+tagName+"][feed_type][pinterest]",type:"checkbox",checked:"checked"}));
            $linkWrap.append($("<label>", {for: "wpfoof-box-media[extra]["+tagName+"][feed_type][pinterest]"}).html('Pinterest'));
            $row.append($linkWrap);
        } else {
            $row.append($("<label>").html(tagName+":"));
            if (typeof wpwoof_select_values[tagName] !== 'undefined') {
                $select = $("<select>", { name: "wpfoof-box-media[extra]["+tagName+"][value]",class:"select short"});
                $.each(wpwoof_select_values[tagName], function (i, item) {
            ...
            if (tagName=='installmentmonths') {
				...
				$w1.append($("<input>", { name: "wpfoof-box-media[extra][installmentamount][value]",placeholder:"Custom value",class:"short wc_input_installmentamount", type: "text"}));
        ...
        $($rowWrapper).insertBefore('hr#hr-befor-add-new-field',div);
    });
