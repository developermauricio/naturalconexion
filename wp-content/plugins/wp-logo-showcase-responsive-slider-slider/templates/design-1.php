...
<div class="wpls-logo-cnt">
	<div class="wpls-fix-box">
		...
		<a href="<?php echo esc_url( $logourl ); ?>" target="<?php echo esc_attr( $link_target ); ?>">
			<img class="wp-post-image" <?php if( $lazyload ) { ?>data-lazy="<?php echo esc_url( $slider_orig_img ); ?>" <?php } ?> src="<?php echo esc_url( $feat_image ); ?>" alt="<?php echo esc_attr( $feat_image_alt ); ?>" />
		</a>
		<?php } else { ?>
		<img class="wp-post-image" <?php if( $lazyload ) { ?>data-lazy="<?php echo esc_url( $slider_orig_img ); ?>" <?php } ?> src="<?php echo esc_url( $feat_image ); ?>" alt="<?php echo esc_attr( $feat_image_alt ); ?>" />
		<?php } ?>
