<?php
/* handle field output */
function wppb_campaign_monitor_handler( $output, $form_location, $field, $user_id, $field_check_errors, $request_data ){
                ...
                if( isset( $user_data ) && !empty( $user_data ) ) {
                    ...
                    if( !empty( $wppb_cmi_list_id ) ) {
                        ...
                        if( empty( $user_subscribe_status ) ) {
                            ...
                            $wrap = new WPPB_CS_REST_Subscribers( $wppb_cmi_list_id, $auth );
...
add_filter( 'wppb_output_form_field_campaign-monitor-subscribe', 'wppb_campaign_monitor_handler', 10, 6 );
add_filter( 'wppb_admin_output_form_field_campaign-monitor-subscribe', 'wppb_campaign_monitor_handler', 10, 6 );


/* handle field save */
function wppb_save_campaign_monitor_value( $field, $user_id, $request_data, $form_location ){
...
add_action( 'wppb_save_form_field', 'wppb_save_campaign_monitor_value', 10, 4 );
add_action( 'wppb_backend_save_form_field', 'wppb_save_campaign_monitor_value', 10, 4 );