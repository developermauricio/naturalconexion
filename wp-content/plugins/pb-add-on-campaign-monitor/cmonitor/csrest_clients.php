 ...
 *
 */
class WPPB_CS_REST_Clients extends WPPB_CS_REST_Wrapper_Base {
     ...
     *         )
     * @access public
     * @return WPPB_CS_REST_Wrapper_Result A successful response will be the ID of the newly created client
     */
     ...
     *     )
     * @access public
     * @return WPPB_CS_REST_Wrapper_Result A successful response will be an object
     * of the form:
     * {
