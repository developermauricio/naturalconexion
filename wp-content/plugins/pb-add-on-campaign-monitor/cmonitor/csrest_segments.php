 ...
 *
 */
class WPPB_CS_REST_Segments extends WPPB_CS_REST_Wrapper_Base {
     ...
     *             )
     *         )
     * @return WPPB_CS_REST_Wrapper_Result A successful response will be the ID of the newly created segment
     */
