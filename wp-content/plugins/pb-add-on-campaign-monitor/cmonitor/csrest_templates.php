 ...
 *
 */
class WPPB_CS_REST_Templates extends WPPB_CS_REST_Wrapper_Base {
     ...
     *         )
     * @access public
     * @return WPPB_CS_REST_Wrapper_Result A successful response will be the ID of the newly created template
     */
