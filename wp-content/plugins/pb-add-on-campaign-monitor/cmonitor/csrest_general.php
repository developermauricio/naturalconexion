 ...
 *
 */
class WPPB_CS_REST_General extends WPPB_CS_REST_Wrapper_Base {
     ...
     * @access public
     */
    function WPPB_CS_REST_Wrapper_Base(
        $auth_details,
        $protocol = 'https',
        ...
        $serialiser = NULL,
        $transport = NULL) {
        $this->WPPB_CS_REST_Wrapper_Base($auth_details, $protocol, $debug_level, $host, $log, $serialiser, $transport);
    }
     ...
     * @return WPPB_CS_REST_Wrapper_Result a successful response will be an array in the form:
     ...
     *
     * @return WPPB_CS_REST_Wrapper_Result A successful response will be an array of the form:
