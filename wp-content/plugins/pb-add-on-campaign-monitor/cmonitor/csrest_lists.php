...
define('WPPB_CS_REST_CUSTOM_FIELD_TYPE_TEXT', 'Text');
define('WPPB_CS_REST_CUSTOM_FIELD_TYPE_NUMBER', 'Number');
define('WPPB_CS_REST_CUSTOM_FIELD_TYPE_MULTI_SELECTONE', 'MultiSelectOne');
define('WPPB_CS_REST_CUSTOM_FIELD_TYPE_MULTI_SELECTMANY', 'MultiSelectMany');
define('WPPB_CS_REST_CUSTOM_FIELD_TYPE_DATE', 'Date');
define('WPPB_CS_REST_CUSTOM_FIELD_TYPE_COUNTRY', 'Country');
define('WPPB_CS_REST_CUSTOM_FIELD_TYPE_USSTATE', 'USState');

define('WPPB_CS_REST_LIST_WEBHOOK_SUBSCRIBE', 'Subscribe');
define('WPPB_CS_REST_LIST_WEBHOOK_DEACTIVATE', 'Deactivate');
define('WPPB_CS_REST_LIST_WEBHOOK_UPDATE', 'Update');
define('WPPB_CS_REST_LIST_UNSUBSCRIBE_SETTING_ALL_CLIENT_LISTS', 'AllClientLists');
define('WPPB_CS_REST_LIST_UNSUBSCRIBE_SETTING_ONLY_THIS_LIST', 'OnlyThisList');
 ...
 *
 */
class WPPB_CS_REST_Lists extends WPPB_CS_REST_Wrapper_Base {
     ...
     * @param $debug_level int The level of debugging required WPPB_CS_REST_LOG_NONE | WPPB_CS_REST_LOG_ERROR | WPPB_CS_REST_LOG_WARNING | WPPB_CS_REST_LOG_VERBOSE
     * @param $host string The host to send API requests to. There is no need to change this
     * @param $log WPPB_CS_REST_Log The logger to use. Used for dependency injection
    ...
    $auth_details,
    $protocol = 'https',
    $debug_level = WPPB_CS_REST_LOG_NONE,
     ...
     *             WPPB_CS_REST_LIST_UNSUBSCRIBE_SETTING_ALL_CLIENT_LISTS or
     *             WPPB_CS_REST_LIST_UNSUBSCRIBE_SETTING_ONLY_THIS_LIST.
     *             See the documentation for details: http://www.campaignmonitor.com/api/lists/#creating_a_list
     *     )
     * @access public
     * @return WPPB_CS_REST_Wrapper_Result A successful response will be the ID of the newly created list
     */
     ...
     *             is WPPB_CS_REST_LIST_UNSUBSCRIBE_SETTING_ALL_CLIENT_LISTS,
     ...
     *     )
     * @access public
     * @return WPPB_CS_REST_Wrapper_Result A successful response will be empty
     */
     ...
     *             WPPB_CS_REST_CUSTOM_FIELD_TYPE_TEXT
     *             WPPB_CS_REST_CUSTOM_FIELD_TYPE_NUMBER
     *             WPPB_CS_REST_CUSTOM_FIELD_TYPE_MULTI_SELECTONE
     *             WPPB_CS_REST_CUSTOM_FIELD_TYPE_MULTI_SELECTMANY
     *             WPPB_CS_REST_CUSTOM_FIELD_TYPE_DATE
     *             WPPB_CS_REST_CUSTOM_FIELD_TYPE_COUNTRY
     *             WPPB_CS_REST_CUSTOM_FIELD_TYPE_USSTATE
     ...
     *     )
     * @access public
     * @return WPPB_CS_REST_Wrapper_Result A successful response will be the
     ...
     * @access public
     * @return WPPB_CS_REST_Wrapper_Result A successful response will be an object of the form
     * array(
     *     {
     ...
     *         be either WPPB_CS_REST_LIST_UNSUBSCRIBE_SETTING_ALL_CLIENT_LISTS or
     *         WPPB_CS_REST_LIST_UNSUBSCRIBE_SETTING_ONLY_THIS_LIST.
     * }
     */
    function get() {
     ...
     *             WPPB_CS_REST_LIST_WEBHOOK_SUBSCRIBE,
     *             WPPB_CS_REST_LIST_WEBHOOK_DEACTIVATE,
     *             WPPB_CS_REST_LIST_WEBHOOK_UPDATE
     ...
     *             WPPB_CS_REST_WEBHOOK_FORMAT_JSON or
     *             WPPB_CS_REST_WEBHOOK_FORMAT_XML
     *         (xml or json)
     *     )
     * @access public
     * @return WPPB_CS_REST_Wrapper_Result A successful response will be the ID of the newly created webhook
     */
