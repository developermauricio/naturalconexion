...
function WPPB_CS_REST_SERIALISATION_get_available($log) {
    $log->log_message('Getting serialiser', __FUNCTION__, WPPB_CS_REST_LOG_VERBOSE);
    if(function_exists('json_decode') && function_exists('json_encode')) {
        return new WPPB_CS_REST_NativeJsonSerialiser($log);
    } else {
        return new WPPB_CS_REST_ServicesJsonSerialiser($log);
    }    
}
class WPPB_CS_REST_BaseSerialiser {
...
class WPPB_CS_REST_DoNothingSerialiser extends WPPB_CS_REST_BaseSerialiser {
...
class WPPB_CS_REST_NativeJsonSerialiser extends WPPB_CS_REST_BaseSerialiser {
...
class WPPB_CS_REST_ServicesJsonSerialiser extends WPPB_CS_REST_BaseSerialiser {
